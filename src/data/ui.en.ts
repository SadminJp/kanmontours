...
export const uiEn: UiStrings = {
  nav: {
    ...
    offer: 'What We Offer',
    tours: 'Discover Two-City Walks',
    aboutUs: 'About Kanmon Tours',
    booking: 'Booking',
    inquiry: 'Inquiry',
    policies: 'Terms & Conditions',
    langSwitchLabel: 'Language',
    langSwitchTo: '日本語ツアー',
    brandTagline: 'We specialize in small-group tours',
  },
  buttons: {
    readMore: 'Read More',
  ...
  inquiryForm: {
    ...
    message: 'Message',
    submit: 'SEND',
    successMessage: 'Thank you! We have received your inquiry and will reply promptly via email.',
